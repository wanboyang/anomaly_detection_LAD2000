...
if __name__ == '__main__':
    dataset = 'LV'
    features_video_dir = '/home/tu-wan/windowswan/dataset/LV/features_video/i3d/combine'
    video_names = os.listdir(features_video_dir)
    abnormal_videos = []

    for v in video_names:
        abnormal_videos.append(v)
    if os.path.exists('/home/tu-wan/windowswan/dataset/LV/train_split.txt') == 0:
        random.shuffle(abnormal_videos)
        train_list = abnormal_videos[:14]
        test_list = abnormal_videos[14:]
        list_writer(list=train_list, txt='/home/tu-wan/windowswan/dataset/LV/train_split.txt')
        list_writer(list=test_list, txt='/home/tu-wan/windowswan/dataset/LV/test_split.txt')
